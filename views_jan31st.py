...
def allviewtest1(request):
    ...
    if request.method=="POST":
        ...
        #######xml format#########
        root_text = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
        ...
        sublevel3=ET.SubElement(root,'RailAvailInfo',Node="Point to Point Tickets")
        ...
        sublevel7 = ET.SubElement(sublevel4, "Departure", DepartureDate=departdatelist1+"TO"+departureTime+":00")
        ...
        sublevel20=ET.SubElement(sublevel3,"FareQualifier")
        sublevel21=ET.SubElement(sublevel3,"ResponsePtPTypes")
        sublevel22=ET.SubElement(sublevel21,"ResponsePtPType").text="TR"
        #print (subrootlevel)
...
def ticket_view1(request):
    if request.method=="POST":
        ...
        # print(callapidata)
        data = pd.read_csv('G:/testdata.txt')
        print(data)
        print(type(data), "*******************")
